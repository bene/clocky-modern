...
function AdminLayout({ title, children, noWrap = false }) {
    return (
        <>
            <Head>
                <title>{title}</title>
                                            ...
                                            <div>
                                                ...
                                                >
                                                    ...
                                                    <img
                                                        ...
                                                        src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixqx=hzXYkBCMXE&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"
                                                        alt=""
                                                    />
                                                </button>
                                            </div>
